...
const DAANGN: HostFixture = {
  ...
  detail: {
    ...
    // 소개는 어드민에서 마크다운으로 작성한다. 목업도 실제 데이터 형태를 따른다.
    description: [
      '당근(Daangn)은 동네 생활을 잇는 **하이퍼로컬 플랫폼**이에요.',
      '',
      '## 엔지니어링',
      '',
      'Kotlin · Rust · Kubernetes 기반의 대규모 트래픽 인프라와 ML 서빙 시스템을 운영하고, 그 경험을 정기적으로 외부 개발자 커뮤니티와 나누고 있어요.',
      '',
      '- 매월 1회 사내 테크 토크를 공개 세션으로 운영',
      '- 분기마다 컨퍼런스 / 해커톤 개최',
      '',
      '자세한 소식은 [당근 팀 블로그](https://about.daangn.com/blog/)에서 확인하세요.',
    ].join('\n'),
    chips: [
