    ...
    <>
      <main className={cn('container')}>
        <div className={cn('top')}>
          <div className={cn('top__info')}>
            <div className={cn('top__info__image_wrapper')}>
              <Image
                className={cn('top__info__image_wrapper__cover_image')}
                alt="이벤트 이미지"
                src={
            ...
            <div className={cn('top__info__info_wrapper')}>
              <div className={cn('top__info__info_wrapper__host_wrapper')}>
                <div className={cn('wrap')}>
                  <div
                    className={cn(
                      'top__info__info_wrapper__host_wrapper__host_image_wrapper'
                    )}
                  >
                    <Image
                      alt="주최"
                  ...
                  <span
                    className={cn(
                      'top__info__info_wrapper__host_wrapper__host_name'
                    )}
                  >
                    네이버
                  </span>
                ...
                {/* 공유하기 & 저장 */}
                <div className={cn('top__info__info_wrapper__button_wrapper')}>
                  <button
                    className={cn(
                      `top__info__info_wrapper__button_wrapper__buttons`,
                      `share-button`,
                      'laptop'
                    )}
                  >
              ...
              {/* 행사 제목 */}
              <div className={cn('top__info__info_wrapper__event_title')}>
                백엔드 | 프리온보딩 인턴십 10월 10월 10월 10월 10월 10월 10월
                10월 10월 10월 10월
              </div>
              {/*  북마크 & 공유 버튼 추가 */}
              <div className={cn('top__info__info_wrapper__date_wrapper')}>
                <div
                  className={cn(
                    'top__info__info_wrapper__date_wrapper__date_type'
                  )}
                >
                  일시
                </div>
                <div
                  className={cn('top__info__info_wrapper__date_wrapper__date')}
                >
                  2024. 07. 23 ~ 20204. 07. 25 23:30
                </div>
              </div>
              <div className={cn('top__info__tag_wrapper')}>
        ...
        <div className={cn('section__detail')}>
          <span className={cn('section__detail__title')}>행사 상세</span>
          <p>
