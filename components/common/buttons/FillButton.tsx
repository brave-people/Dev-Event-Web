...
function FillButton({ onClick, label, color, icon, iconStyle, rounded, large }: FillButtonProps) {
  return (
    <button
      className={cx('button', `color--${color}`, 'default', `${rounded && 'type--rounded'}`, { large: large })}
      onClick={onClick}
    >
